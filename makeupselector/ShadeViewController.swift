...
class ShadeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource
{
    ...
    @IBAction func sliderValueChanged(sender: UISlider) {
        ...
        self.temp_detaildata.imageArray_please.removeAll()
        ...
        self.temp_detaildata.title1_array_please.removeAll()
        ...
        self.temp_detaildata.title2_array_please.removeAll()
        ...
        self.temp_detaildata.title3_array_please.removeAll()
        ...
        self.temp_detaildata.price_array_please.removeAll()
        ...
        self.temp_detaildata.whatitis_array_please.removeAll()
        ...
        self.temp_detaildata.whatitdoes_array_please.removeAll()
